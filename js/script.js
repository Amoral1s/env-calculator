jQuery(document).ready(function ($) {
			...
			if (bar) {
				for (answer in questions[item].answers) {
					...
					newBar.innerHTML = `
						<div class="left">
							<div class="bar">
								<div class="inner" style="background: ${E_block_colors[index]};width: ${+questions[item].answers[answer] * 100}%"><p>${+questions[item].answers[answer] * 100}%</p></div>
							</div>
						</div>
						<div class="right">
			...
			if (bar) {
				for (answer in questionsS[item].answers) {
					...
					newBar.innerHTML = `
						<div class="left">
							<div class="bar">
								<div class="inner" style="border-left-color: ${S_block_colors[indexS]}; background: ${S_block_colors[indexS]};width: ${+questionsS[item].answers[answer] * 100}%"><p>${+questionsS[item].answers[answer] * 100}%</p></div>
							</div>
						</div>
						<div class="right">
			...
			if (bar) {
				for (answer in questionsG[item].answers) {
					...
					newBar.innerHTML = `
						<div class="left">
							<div class="bar">
								<div class="inner" style="background: ${G_block_colors[indexG]};width: ${+questionsG[item].answers[answer] * 100}%"><p>${+questionsG[item].answers[answer] * 100}%</p></div>
							</div>
						</div>
						<div class="right">
	...
	const diagrammFunc = (E_calc, S_calc, G_calc, ESG_calc) => {
		...
		//const E_block_colors = ['#4F7800', '#769241', '#93B94A', '#ABC971', '#D4F596'];
		...
		//const S_block_colors = ['#D65303', '#D8641D', '#F8853E', '#DB9065', '#F4BF9F', '#FBE4D5'];
		...
		//const G_block_colors = ['#000000', '#3D3D3D', '#525252', '#6D6D6D', '#949797', '#AEB0B1', '#D9D9D9', '#F0F0F0'];
